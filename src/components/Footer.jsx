...
const Footer = () => {
  ...
  return (
    <footer className="bg-dark-bg border-t border-dark-border text-white py-20 px-6">
        ...
        >
          ...
          <div className="flex justify-center gap-6 mb-12">
            {[
              ...
              <motion.a
                ...
                className="px-6 py-3 bg-dark-surface border border-dark-border rounded-full text-sm text-gray-400 hover:text-white hover:border-accent-primary transition-all duration-300"
          ...
          <div className="border-t border-dark-border pt-8">
            ...
            >
              ...
              <span className="text-accent-primary">Barcelona</span> &{' '}
              <span className="text-accent-secondary">Taipei</span>
            </motion.p>
          </div>
        </motion.div>
      </div>
